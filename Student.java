...
public class  Student extends JFrame implements ActionListener {
		...
		JTextField jt1,jt2,jt3,jt4,jt5,jt6,jt7,jt8 ,jp;
		...
		Font f;
			...
			jl6 = new JLabel("tenth_percent :");
			jt6 = new JTextField(20);
			jl6.setFont(f);
			jt6.setFont(f);
			
			
			jl7 = new JLabel("twelfth_percent :");
	...
	public void actionPerformed(ActionEvent et){
				...
				ResultSet rs=st.executeQuery("select * from record where student_id="+student_id);
				if(rs.next()){
					...
					jp.setText(rs.getInt(11)+"");
					flag=2;
				}
				else{
					flag=0;
					JOptionPane.showMessageDialog(null,"Record not found");
					  Student ob= new Student("Insert Record");
				  ob.setSize(950,1000);
				   ob.setVisible(true);	
				...
				System.out.println("Driver : "+ e.getMessage());
			     ...
			     Management ob = new Management("management Record");
				 ob.setSize(950,1000);
				 ob.setVisible(true);
				 this.setVisible(false);
			   ...
			   try{
				...
				System.out.println("Driver : "+ e.getMessage());
					...
					System.out.println("SQL :  "+e.getMessage());
						 ...
						 String  number = jt5.getText();
						 int tenth_percent = Integer.parseInt(jt6.getText());
						 int twelfth_percent = Integer.parseInt(jt7.getText());
						 int btech_percent = Integer.parseInt(jt8.getText());
						 String gender=null;
						 String branch=null ;
						 int back= Integer.parseInt(jp.getText());
			...
			try{
				...
				String msg="";
  					if(flag==0){
					ps=cn.prepareStatement("insert into record values(?,?,?,?,?,?,?,?,?,?,?)");
					            ps.setInt(1,student_id);
								ps.setString(2,student_name);
								ps.setString(3,father_name);
								ps.setString(4,email);
								ps.setString(5,number);  
								ps.setInt(6,tenth_percent);
								ps.setInt(7,twelfth_percent);
								ps.setInt(8,btech_percent );
                    ...
                    ps=cn.prepareStatement("update  record set student_name=?,father_name=?,email=?,number=?,tenth_percent=?,twelfth_percent=?,btech_percent=?,gender=?,branch=?,back=? where student_id=?");
					ps.setString(1,student_name);
					ps.setString(2,father_name);
					ps.setString(3,email);
					ps.setString(4,number);
					ps.setInt(5, tenth_percent);
					ps.setInt(6,twelfth_percent);
					ps.setInt(7,btech_percent);
					...
					msg="Record Updated";
                     ...
                     ps=cn.prepareStatement("delete from record where student_id=?");
				     ps.setInt(1,student_id);
					 msg="Record Deleted";
				...
				if(ps.executeUpdate()>0){
				   JOptionPane.showMessageDialog(null,msg); 
				    Student d= new Student("Insert Record");
				   d.setSize(950,1000);
				   d.setVisible(true);	
				   this.setVisible(false);
				}
        ...
        public static void main(String []arr){
		      Student ob=new  Student("Student Frame");
			  ob.setSize(500,500);
			  ob.setVisible(true);
			 } 
